import type { Route, HandlerFunction, EventOf, MenuCategoryParams } from './types';
...
export default class Router {
    ...
    build() {
        ...
        eventBus.on('NAVIGATED', (e: EventOf<'NAVIGATED'>) => {
            const categoryParam = e.route.param as MenuCategoryParams;
            this.navigate(`#${e.route.name}/${categoryParam.category}`);
        });
        return this;
    }
}
